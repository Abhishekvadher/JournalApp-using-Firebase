...
public class AddJournalActivity extends AppCompatActivity {
    ...
    private EditText thoughtsEditText,titleEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleEditText = findViewById(R.id.poster_title_et);
        thoughtsEditText = findViewById(R.id.poster_description_et);
        currentUserTextView = findViewById(R.id.post_username_textView);
        imageView = findViewById(R.id.poster_imageView);
        savePost = findViewById(R.id.post_save_button);
